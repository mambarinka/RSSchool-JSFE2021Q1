...
export class TableWinners extends Table {
  ...
  constructor() {
    ...
    this.cellNumber.classList.add('table-winners__row', 'table-winners__row--head');
    this.cellNumber.textContent = 'Number';
    this.cellCar = this.hrowHead.insertCell(1);
    this.cellCar.classList.add('table-winners__row', 'table-winners__row--head', 'table-winners__row--car');
    this.cellCar.textContent = 'Car';
    this.cellName = this.hrowHead.insertCell(2);
    this.cellName.classList.add('table-winners__row', 'table-winners__row--head');
    this.cellName.textContent = 'Name';
    this.cellWins = this.hrowHead.insertCell(3);
    this.cellWins.classList.add('table-winners__row', 'table-winners__row--head');
    this.cellWins.textContent = 'Wins';
    this.cellBsetTime = this.hrowHead.insertCell(4);
    this.cellBsetTime.classList.add('table-winners__row', 'table-winners__row--head');
