...
export const Clothes: () => JSX.Element = () => {
  ...
  return (
    <main className={cn(styles.pageClothes, isPlayMode ? 'play-mode' : null)}>
      ...
      <CardList />
      <button
        className={cn(styles.pageClothesButtonStart, !isPlayMode ? null : openClassButtonStart ? null : styles.open)}
        onClick={ButtonStartHandler}
      ></button>
      <button
        className={cn(styles.pageClothesButtonRepeat, !isPlayMode ? null : openClassButtonStart ? styles.repeat : null)}
