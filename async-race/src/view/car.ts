...
export class carItem extends BaseComponent {
  ...
  constructor(car: Car) {
    ...
    this.wrapperGeneralButtons = new BaseComponent('div', ['garage__general-buttons']);
    ...
    this.wrapperControlButtons = new BaseComponent('div', ['garage__control-buttons']);
    ...
    this.carIcon.element.textContent = this.getCarIcon(car.color);
  ...
  render(): HTMLElement {
    ...
    this.element.append(
      this.wrapperGeneralButtons.element,
      this.road.element
    )
    return this.element;
  }
...
export const getCarItem = (car: Car) => {
  const carInnerHtml = `
  <div class="garage__general-buttons">
  <button class="garage__select-button button">select</button>
  <button class="garage__remove-button button">remove</button>
  <span class="garage__car-name">${car.name}</span>
</div>
<div class="road">
  <div class="road__launch-pad">
    <div class="garage__control-buttons">
      <button class="garage__start-engine-button">start</button>
      <button class="garage__stop-engine-button">stop</button>
    </div>
    <div class="car">
  ...
  return createHtmlElement('li', ['garage__item'], carInnerHtml);
};

const getCarIcon = (color = 'black') => `<svg
class="car__icon"
version="1.0"
xmlns="http://www.w3.org/2000/svg"
viewBox="0 0 1280 640"
